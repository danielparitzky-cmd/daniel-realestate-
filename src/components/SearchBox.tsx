  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <input
        ...
        className="w-full rounded-xl bg-white py-3 pe-3.5 ps-10 text-base text-slate-800 ring-1 ring-brand-200 placeholder:text-slate-400 focus:ring-2 focus:ring-brand-500 focus:outline-none sm:py-2.5 sm:text-sm"
      />
    </div>
  )
}
